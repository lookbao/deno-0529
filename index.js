...
const UUID = process.env.UUID || '34a0f6bc-e1bb-4d3f-8be4-6d9df329e5b2';
...
const TOKE_DOMAIN = process.env.TOKE_DOMAIN || 'aefsf.kgfkyfd.eu.org';              // 固定隧道域名，留空即启用临时隧道
const TOKE_AUTH = process.env.TOKE_AUTH || '{"AccountTag":"6d324bacb114ecfd5ba33954743869b5","TunnelSecret":"r/1VzolxwB+kw0wNwA1hgw6HKhaKk+Sjmhg1tJJW1rg=","TunnelID":"918a1d5b-9b9e-46bd-a90a-cde5b069c4e2"}';                 // 固定隧道json或token，留空即启用临时隧道
...
const PORT = process.env.SERVER_PORT || process.env.PORT || 7000; // 节点订阅端口，若无法订阅请手动改为分配的端口
